        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php } ?>
                    <?php if (isset($config['setting']['link_map']) && $config['setting']['link_map'] == true) { ?>
                        <div class="form-group col-md-4 col-sm-6">
                            <label for="link_map">Link google map:</label>
                            <input type="text" class="form-control text-sm" name="data[options][link_map]" id="link_map" placeholder="Link google map" value="<?= (!empty($flash->has('link_map'))) ? $flash->get('link_map') : @$options['link_map'] ?>">
                        </div>
                    <?php } ?>
                </div>
