...
<section class="content">
    <form class="validation-form form-box-price" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
                ...
                <?php if (isset($config['product'][$type]['images2']) && $config['product'][$type]['images2'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        ...
                        <div class="card-body">
                            ...
                            $photo2Detail['dimension'] = "Width: " . $config['product'][$type]['width2'] . " px - Height: " . $config['product'][$type]['height2'] . " px (" . $config['product'][$type]['img_type'] . ")";
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php } ?>
                    <div class="col-12 box_price_pro">
                        <div class="row">
                            <?php if (isset($config['product'][$type]['regular_price']) && $config['product'][$type]['regular_price'] == true) { ?>
                                <div class="col-12">
                                    <div class="d-block text-success"><label>Giá mặc định:</label> <span class="text-info">(Giá mặc định cho tất cả thuộc tính sản phẩm khi không nhập giá)</span></div>
                                </div>
